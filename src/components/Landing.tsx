...
export default function Landing() {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center lg:w-full lg:mx-0 my-4 lg:my-0">
      ...
      <div
        className="flex items-center justify-center w-full lg:w-1/4 border-2 rounded-4xl h-[300px] mx-2 mb-4 lg:mb-0"
        style={{ backgroundColor: 'var(--foreground)', color: 'black' }}
      >
        <div className="border-2 rounded-full w-3/4 p-2 h-7/8 lg:h-3/4"></div>
      </div>
